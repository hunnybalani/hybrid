package dis.hybrid.saga.service;

import dis.hybrid.dto.InventoryRequestDTO;
import dis.hybrid.dto.OrchestratorRequestDTO;
import dis.hybrid.dto.OrchestratorResponseDTO;
import dis.hybrid.dto.PaymentRequestDTO;
import dis.hybrid.enums.OrderStatus;
import dis.hybrid.saga.service.steps.*;
...
public class OrchestratorService {
    ...
    public Mono<OrchestratorResponseDTO> orderProduct(final OrchestratorRequestDTO requestDTO){
        this.orderSink.tryEmitNext(requestDTO);
